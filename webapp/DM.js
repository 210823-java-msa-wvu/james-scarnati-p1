 ...
 var ajaxRequest = new XMLHttpRequest();
    ...
    function getApp() {
     ...
     var ajaxRequest = new XMLHttpRequest();
          ajaxRequest.onreadystatechange = function(){
            ...
            if(ajaxRequest.readyState == 4){
              ...
              if(ajaxRequest.status == 200){
                ...
                document.getElementById("dmCheck").hidden = false;
        ...
        document.getElementById('checked').addEventListener("click", checkInfo);


                              function checkInfo(){

                                var rid = document.getElementById('id').value;
                                var info = document.getElementById('check').value
                          ...
                          ajaxRequest.open('PUT', 'http://localhost:8080/P1/fas');
