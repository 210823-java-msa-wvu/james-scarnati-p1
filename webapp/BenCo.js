...
function getReqs() {
 ...
 var ajaxRequest = new XMLHttpRequest();
    ...
    function updateReq(){
      ...
      var dhInfoReq= document.getElementById('dh').value;
...
ajaxRequest.open('PUT', 'http://localhost:8080/P1/benco');
...
ajaxRequest.send(JSON.stringify(changeReq));
    ...
    document.getElementById('changeAmount').addEventListener("click", changeAmount);
...
ajaxRequest.open('POST', 'http://localhost:8080/P1/benco');
...
ajaxRequest.send(JSON.stringify(inf));
               ...
               document.getElementById('checked').addEventListener("click", setPass);

                          function setPass(){

                            var rid = document.getElementById('id').value;
                            var info = document.getElementById('pass').value
                      ...
                      ajaxRequest.open('POST', 'http://localhost:8080/P1/fas');
